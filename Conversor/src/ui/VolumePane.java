...
public class VolumePane {
	
	private static JPanel pane_volumen = new JPanel();
	private static ConversionController conversionController = ConversionController.getInstance();
	private static Double result;
	
	public static JPanel pane() {
		pane_volumen.setBounds(0,80,796,426);
		pane_volumen.setLayout(null);
		pane_volumen.setVisible(false);	
		
		JLabel lblConversionType = new JLabel("Volumen");
		...
		pane_volumen.add(lblConversionType);
		...
		pane_volumen.add(lblConversorAlura);
		...
		inputMeasure.addItem("Litro");
		inputMeasure.addItem("Galon");
		inputMeasure.addItem("Cuarto");
		inputMeasure.addItem("Pie Cubico");
		inputMeasure.setFont(new Font("Tahoma", Font.PLAIN, 18));
		pane_volumen.add(inputMeasure);
		...
		outputMeasure.addItem("Litro");
		outputMeasure.addItem("Galon");
		outputMeasure.addItem("Cuarto");
		outputMeasure.addItem("Pie Cubico");
		outputMeasure.setFont(new Font("Tahoma", Font.PLAIN, 18));
		pane_volumen.add(outputMeasure);
