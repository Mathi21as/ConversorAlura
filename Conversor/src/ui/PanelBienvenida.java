...
public class PanelBienvenida {
	private static JPanel panel_bienvenida = new JPanel();
	
	public static JPanel panel() {
		panel_bienvenida.setBounds(0,80,796,426);
		...
		panel_bienvenida.add(lblBienvenido);
		...
		panel_bienvenida.add(lblDescripcion);
		...
		panel_bienvenida.add(lblDesarrollador);
		...
		panel_bienvenida.add(lblBackground);
		
		return panel_bienvenida;
	}
}
