...
public class DivisaLogic {
	...
	private final double dolar = 244.37; //el valor corresponde al dolar blue, no al dolar convencional
	private final double euro = 263.34;
	private final double libraEsterlina = 306.82;
	...
	public double dolarAPesos(double divisa) {
		return divisa*dolar;
	}
	
	public double euroAPesos(double divisa) {
		return divisa*euro;
	}
	
	public double libraEsterlinaAPesos(double divisa) {
		return divisa*libraEsterlina;
	}
	
	public double yenAPesos(double divisa) {
		return divisa*yen;
	}
	
	public double wonAPesos(double divisa) {
		return divisa*won;
	}
}
